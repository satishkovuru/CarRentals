<%@ Page Title="Models" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Toyota.aspx.cs" Inherits="Toyota" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
        ...
        <table style="width: 391px; height: 370px; text-align: left;">
           ...
           "images/Corolla.jpg" style="width: 303px; height: 203px" /> &nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Toyota Corolla"></asp:Label><br />
                    <br />
                    <ul>
                        <li>5 Seater </li>
                        <li>Petrol Engine</li>
                ...
                <img src=
                    "images/camry.jpg" style="width: 303px; height: 203px" />
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Toyota Camry"></asp:Label><br />
                    <br />
                    <ul>
                        <li>5 Seater</li>
            ...
            <tr>
                ...
                <img src="images/supra.jpg" style="width: 303px; height: 203px" />
               
                    &nbsp; &nbsp;
                
              
                    &nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="14pt" Text="Toyota Supra" style="background-image: url(images/civic.jpg); background-repeat: no-repeat"></asp:Label><br />
                    <br />
                    <ul>
                        <li>4 Seater</li>
                ...
                <img src="images/orlando.jpg" style="width: 303px; height: 203px" />&nbsp;<br />
                    &nbsp;<asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="14pt" Text="Toyota Orlando"></asp:Label><br />
                    <br />
                    <ul>
                        <li>5 Seater</li>
                        <li>Petrol Engine</li>
