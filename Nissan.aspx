<%@ Page Title="Models" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Nissan.aspx.cs" Inherits="Nissan" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
        ...
        <table style="width: 391px; height: 370px; text-align: left;">
           ...
           "images/sentra.jpg" style="width: 303px; height: 203px" /> &nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Nissan Sentra"></asp:Label><br />
                    <br />
                    <ul>
                        <li>5 Seater </li>
                        <li>Petrol Engine</li>
                ...
                <img src=
                    "images/altima.jpg" style="width: 303px; height: 203px" />
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Nissam Altima"></asp:Label><br />
                    <br />
                    <ul>
                        <li>5 Seater</li>
            ...
            <tr>
                ...
                <img src="images/murano.jpg" style="width: 303px; height: 203px" />
               
                    &nbsp; &nbsp;
                
              
                    &nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="14pt" Text="Nissan Murano" style="background-image: url(images/civic.jpg); background-repeat: no-repeat"></asp:Label><br />
                    <br />
                    <ul>
                        <li>4 Seater</li>
                ...
                <img src="images/Nissan-PathfinderSUV.jpg" style="width: 303px; height: 203px" />&nbsp;<br />
